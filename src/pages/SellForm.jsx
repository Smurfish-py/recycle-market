        ...
        <div className="mt-16 flex justify-center">
            <div className="lg:w-1/2 py-2 px-4 border border-stone-300 rounded-lg">
                <form className="flex flex-col justify-center" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <input type="hidden" value={decode.id} name="id" />
                        ...
                        <div className="flex flex-row gap-2 items-center mb-4">
                            <div className="flex">
                                ...
                                <input type="file" className="btn sr-only" id="file" name="productPhoto" accept="image/*" onChange={handleFileChange} multiple/>
                            </div>
