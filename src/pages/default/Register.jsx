    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.data == undefined) {
                setMsg({ status: res.status, pesan: res.pesan });
            } else {
                            ...
                            <form onSubmit={handleSubmit} method="post" className="font-poppins flex flex-col gap-4">
                                ...
                                <div id="button-and-helps">
                                    ...
                                    <button 
                                        type="submit" 
                                        disabled={isLoading}
                                        className="btn-solid w-full h-10 flex justify-center items-center md:text-sm lg:text-base hover:brightness-90 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
                                    >
                                        {isLoading ? (
                                            <>
