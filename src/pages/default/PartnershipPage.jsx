                    ...
                    <div className='px-2'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 md:gap-2'>
                            ...
                            <div className='px-2 py-2 flex flex-row items-center gap-4'>
                                ...
                                <h3 className='flex-5/6'>Badge certified di sebelah nama user yang menunjukkan bahwa anda adalah user terverifikasi <strong>(Jika lolos tahap verifikasi oleh admin)</strong></h3>
                            </div>
                            <div className='px-2 py-2 flex flex-row items-center gap-4'>
                                <div className='flex-1/6 flex items-center justify-center'>
